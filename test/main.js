...
(function(exports) {
  ...
  var DOM_HTML_HTMLProgressElement = PS["DOM.HTML.HTMLProgressElement"];
  ...
  var Point3 = function (x) {
      return x;
  };
  var Point2 = function (x) {
      return x;
  };
  ...
  var clearCanvas = function __do() {
      ...
      if (v instanceof Data_Maybe.Just) {
          ...
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Graphics_Canvas.clearRect(v3)({
              x: 0.0, 
              y: 0.0, 
              w: v1, 
              h: v2
      ...
      throw new Error("Failed pattern match at Main line 112, column 3 - line 118, column 25: " + [ v.constructor.name ]);
  };
  var forTen = function (ctx) {
      return function (pos) {
          return function __do() {
              var v = clearCanvas();
              if (pos === 0) {
                  return drawCube(ctx)({
                      ...
                      qx: $$Math.pi / 4.0, 
                      qy: $$Math.pi / (3.0 + Data_Int.toNumber(pos) + 10.0), 
                      qz: $$Math.pi / 4.0
                  })();
              };
              var v1 = forTen(ctx)(pos - 1 | 0)();
              return drawCube(ctx)({
                  x: 300.0, 
                  y: 500.0, 
                  z: 250.0, 
      ...
      return __unused()((function () {
          if (v instanceof Data_Maybe.Just) {
              return function __do() {
                  ...
                  return forTen(v1)(100)();
              };
          };
          throw new Error("Failed pattern match at Main line 131, column 3 - line 132, column 3: " + [ v.constructor.name ]);
      })())();
  });
  exports["Angle"] = Angle;
  exports["Cube"] = Cube;
